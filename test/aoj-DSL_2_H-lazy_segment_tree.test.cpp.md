...
data:
  ...
  bundledCode: "#line 1 \"test/aoj-DSL_2_H-lazy_segment_tree.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_H\"\n\n#include\
    ...
    \    }\n};\n\n}  // namespace algorithm\n\n\n#line 8 \"test/aoj-DSL_2_H-lazy_segment_tree.test.cpp\"\
    \n\nint main() {\n    int n;\n    int q;\n    std::cin >> n >> q;\n\n    using\
    \ S = int;\n    using F = int;\n    constexpr S e = 1e8;\n    constexpr F id =\
  ...
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_H\"\
    ...
    \ = [&](const F &f, const S &x) -> S { return x + f; };\n    auto composition\
    \ = [&](const F &f, const F &g) -> F { return f + g; };\n    algorithm::LazySegTree<S,\
    \ F> segtree(op, mapping, composition, e, id, std::vector<S>(n, 0));\n\n    while(q--)\
    \ {\n        int type;\n        std::cin >> type;\n\n        if(type == 0) {\n\
    \            int s, t;\n            int x;\n            std::cin >> s >> t >>\
    \ x;\n            t++;\n\n            segtree.apply(s, t, x);\n        } else\
    \ {\n            int s, t;\n            std::cin >> s >> t;\n            t++;\n\
  ...
  verifiedWith: []
documentation_of: test/aoj-DSL_2_H-lazy_segment_tree.test.cpp
layout: document
redirect_from:
- /verify/test/aoj-DSL_2_H-lazy_segment_tree.test.cpp
- /verify/test/aoj-DSL_2_H-lazy_segment_tree.test.cpp.html
