...
data:
  ...
  bundledCode: "#line 1 \"test/aoj-ALDS1_4_B-binary_search.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/courses/lesson/1/ALDS1/4/ALDS1_4_B\"\n\n\
    ...
    \ &eval) {\n    while(ng - ok > eps) {\n        Type mid = ok + (ng - ok) / 2;\n\
    \        (eval(mid) ? ok : ng) = mid;\n    }\n    return ng;\n}\n\n}  // namespace\
    \ algorithm\n\n\n#line 7 \"test/aoj-ALDS1_4_B-binary_search.test.cpp\"\n\nint\
    \ main() {\n    int n;\n    std::cin >> n;\n\n    std::vector<int> s(n);\n   \
  ...
  verifiedWith: []
documentation_of: test/aoj-ALDS1_4_B-binary_search.test.cpp
layout: document
redirect_from:
- /verify/test/aoj-ALDS1_4_B-binary_search.test.cpp
- /verify/test/aoj-ALDS1_4_B-binary_search.test.cpp.html
