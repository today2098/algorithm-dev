...
data:
  ...
  bundledCode: "#line 1 \"test/aoj-DSL_2_F-lazy_segment_tree.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_F\"\n\n#include\
    ...
    \    }\n};\n\n}  // namespace algorithm\n\n\n#line 7 \"test/aoj-DSL_2_F-lazy_segment_tree.test.cpp\"\
    \n\nint main() {\n    int n;\n    int q;\n    std::cin >> n >> q;\n\n    using\
  ...
  verifiedWith: []
documentation_of: test/aoj-DSL_2_F-lazy_segment_tree.test.cpp
layout: document
redirect_from:
- /verify/test/aoj-DSL_2_F-lazy_segment_tree.test.cpp
- /verify/test/aoj-DSL_2_F-lazy_segment_tree.test.cpp.html
