...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo-addition_of_hex_big_integers-binary_bigint.test.cpp\"\
    ...
    \        return oss.str();\n    }\n};\n\n}  // namespace algorithm\n\n\n#line\
    \ 6 \"test/yosupo-addition_of_hex_big_integers-binary_bigint.test.cpp\"\n\nint\
    \ main() {\n    int t;\n    std::cin >> t;\n\n    for(int i = 0; i < t; ++i) {\n\
  ...
  verifiedWith: []
documentation_of: test/yosupo-addition_of_hex_big_integers-binary_bigint.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo-addition_of_hex_big_integers-binary_bigint.test.cpp
- /verify/test/yosupo-addition_of_hex_big_integers-binary_bigint.test.cpp.html
