...
data:
  ...
  attributes:
    ...
    document_title: "Longest Increasing Subsequence\uFF08\u6700\u9577\u5897\u52A0\u90E8\
      \u5206\u5217\uFF09"
    links: []
  bundledCode: "#line 1 \"lib/DP/longest_increasing_subsequence.hpp\"\n\n\n\n/**\n\
    ...
    \ >\nstd::vector<int> lis(const std::vector<Type> &v, Func comp = [](const Type\
    ...
    \ std::vector<Type> &v, Func comp = [](const Type &a, const Type &b) -> bool {\
  ...
  requiredBy: []
  timestamp: '2024-09-08 16:13:42+09:00'
  verificationStatus: LIBRARY_NO_TESTS
  verifiedWith: []
documentation_of: lib/DP/longest_increasing_subsequence.hpp
layout: document
redirect_from:
- /library/lib/DP/longest_increasing_subsequence.hpp
- /library/lib/DP/longest_increasing_subsequence.hpp.html
title: "Longest Increasing Subsequence\uFF08\u6700\u9577\u5897\u52A0\u90E8\u5206\u5217\
  \uFF09"
---
## 概要

長さ $N$ の数列 $\lbrace a_0, a_1, \cdots, a_{N-1} \rbrace$ に対して，最長増加部分列 (LIS: Longest Increasing Subsequence) の長さを求める．
