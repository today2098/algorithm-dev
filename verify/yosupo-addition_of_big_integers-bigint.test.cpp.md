...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo-addition_of_big_integers-bigint.test.cpp\"\
    ...
    \ &words, bool neg) : m_words(words), m_neg(neg) {}\n    explicit Bigint(std::vector<int32_t>\
    ...
    \    }\n};\n\n}  // namespace algorithm\n\n\n#line 6 \"verify/yosupo-addition_of_big_integers-bigint.test.cpp\"\
    \n\nint main() {\n    int t;\n    std::cin >> t;\n\n    for(int i = 0; i < t;\
...
layout: document
redirect_from:
- /verify/verify/yosupo-addition_of_big_integers-bigint.test.cpp
- /verify/verify/yosupo-addition_of_big_integers-bigint.test.cpp.html
