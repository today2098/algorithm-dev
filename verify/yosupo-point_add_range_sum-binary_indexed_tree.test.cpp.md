...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo-point_add_range_sum-binary_indexed_tree.test.cpp\"\
    ...
    \ }\n};\n\nnamespace binary_indexed_tree {\n\ntemplate <typename S>\nusing range_sum_binary_indexed_tree\
    \ = BIT<algebra::group::addition<S>>;\n\ntemplate <typename S>\nusing range_xor_binary_indexed_tree\
    \ = BIT<algebra::group::bit_xor<S>>;\n\n}  // namespace binary_indexed_tree\n\n\
    }  // namespace algorithm\n\n\n#line 8 \"verify/yosupo-point_add_range_sum-binary_indexed_tree.test.cpp\"\
    \n\nint main() {\n    int n;\n    int q;\n    std::cin >> n >> q;\n\n    using\
    \ binary_indexed_tree_type = typename algorithm::binary_indexed_tree::range_sum_binary_indexed_tree<long\
