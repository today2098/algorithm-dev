...
data:
  libraryCategories:
  - name: algorithm/DataStructure/Others
    pages:
  ...
  - name: algorithm/DataStructure/SegmentTree
    pages:
    - icon: ':heavy_check_mark:'
    ...
    - icon: ':heavy_check_mark:'
      ...
      title: Sparse Table
  - name: algorithm/DataStructure/UnionFind
    pages:
    - icon: ':warning:'
  ...
  - name: algorithm/Graph/Others
    ...
    - icon: ':heavy_check_mark:'
      ...
      title: "Topological Sort\uFF08\u30C8\u30DD\u30ED\u30B8\u30AB\u30EB\u30BD\u30FC\
        \u30C8\uFF09"
  - name: algorithm/Graph/ShortestPath
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: algorithm/Math/Algebra
    ...
    - icon: ':heavy_check_mark:'
      ...
      title: "\u5E73\u65B9\u6839\uFF08\u30CB\u30E5\u30FC\u30C8\u30F3\u6CD5\uFF09"
  - name: algorithm/Math/Combinatorics
    pages:
    - icon: ':heavy_check_mark:'
    ...
    - icon: ':warning:'
      ...
      title: "Pascal's Triangle\uFF08\u30D1\u30B9\u30AB\u30EB\u306E\u4E09\u89D2\u5F62\
        \uFF09"
  - name: algorithm/Math/Convolution
    pages:
    - icon: ':heavy_check_mark:'
  ...
  - name: algorithm/Math/ModularArithmetic
    pages:
    - icon: ':warning:'
